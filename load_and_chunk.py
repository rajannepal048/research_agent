...
# ---------------Step 1: VARIABLES SETUP AND CREATE PDF FOLDER---------------
...
# ---------------Step 2: LOAD ALL PDFs FROM THE pdfs/folder---------------
...
# ---------------Step 3: PRINTING SUMMARY AND CHUNKING---------------
...
# Next Step in the embed_and_store.py file